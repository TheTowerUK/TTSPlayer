...
**Status:** Proposed — comic reader architecture **provisionally validated** (2026-07-25); book reader not started; Phase 6.3 **In Progress**  
...
**Milestone:** M6 — Phase 6.3 (comics, in progress); Phase 6.4 (books) open  
...
1. Introduce **dedicated reader surfaces**:
   ...
   - Book reader (PDF / EPUB document model) — Phase 6.4
