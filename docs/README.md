...
| Folder | Purpose |
|---|---|
| [`architecture/`](./architecture/) | [Path mapping](./architecture/path-mapping.md), [media access abstraction](./architecture/media-access-abstraction.md) |
...
| M3.5 | Media Access Foundation | ✅ Accepted — Phase 4 active |
