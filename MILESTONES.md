...
| **Release** | Tags, version, release summary | ✅ Complete (2026-07-29) — [m6-complete.md](docs/release/m6-complete.md) |

→ [M6 plan](docs/roadmap/m6-plan.md)
→ [M6 release summary](docs/release/m6-complete.md)
